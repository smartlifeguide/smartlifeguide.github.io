...
**メインペルソナ: 45歳・パート勤務の主婦**
- Google検索で「○○ おすすめ」「○○ 比較」と調べる
- SNSやAIチャットは使い慣れていない → ブログ記事を信頼する世代
- 家族の生活に関わる情報（家電、節約、健康、教育費、親の介護）に強い関心

**ニッチカテゴリ (2026年2月〜)**
1. 家電・生活家電: ロボット掃除機、食洗機、空気清浄機、ドラム式洗濯機
2. 節約・家計管理: 電気代節約、食費節約、格安SIM比較、家計簿の付け方
3. 健康・体のケア: 肩こり解消グッズ、目の疲れ対策、腰痛マットレス、睡眠改善
4. 教育費・子育てマネー: 教育費の貯め方、学資保険、タブレット学習、塾の選び方
5. 見守り・シニアケア: 親の見守りサービス、シニアスマホ、介護保険、見守りカメラ
...
- [x] Gemini API キー設定 & テスト実行
- [x] GitHub リポジトリ設定 (Secrets, Pages 有効化)
- [x] ペルソナ再定義 + ニッチピボット
- [x] サイト名変更 + ブランディング更新
- [x] 旧記事・旧キーワードデータ削除
- [ ] 新ニッチで初期記事バッチ生成
